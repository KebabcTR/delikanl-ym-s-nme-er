...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["registerid"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setDescription(`<a::775837551470706700> Toplam Kayıtların: \`${kayıtlar}\`
<a::775837529341558828> Toplam Erkek Kayıtların: \`${erkek}\`
<::770989969480613888> Toplam Kadın Kayıtların: \`${kadın}\``)
.setFooter(`Polaris Register`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
...
.setDescription(`<a::775837551470706700> Toplam Kayıtların: \`${kayıtlar1}\`
<a::775837529341558828> Toplam Erkek Kayıtların: \`${erkek1}\`
<::770989969480613888> Toplam Kadın Kayıtların: \`${kadın1}\``)
.setFooter(`Polaris Register`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
